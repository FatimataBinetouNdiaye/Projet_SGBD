# Generated by Django 4.2.19 on 2025-04-03 19:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ET', 'Étudiant'), ('PR', 'Professeur')], max_length=2, verbose_name='Rôle')),
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='utilisateur_groups', related_query_name='utilisateur', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='utilisateur_permissions', related_query_name='utilisateur', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
